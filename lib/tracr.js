...
document.addEventListener('mouseup', function (e) {
  ...
  if (selection.length > 0) {
    renderNotification(rightRail,selection);
...
function renderNotification(anchor, selection) {
  notification.innerHTML = selection;
 
  var pos = $("div.right_rail").position()
  console.log(pos);
  //notification.style.top = pos.top - 10 + 'px';
  //notification.style.left = pos.left - 10 + 'px';
